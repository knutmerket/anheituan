...
**Baishaxi (白沙溪)** is arguably the most well-known producer of Qianliang tea (and Anhua heicha in general) today, so it likely needs no introduction. In 2010, the company participated as part of the Hunan pavilion of the World Expo in Shanghai. This QLC was one of the teas made for that occasion.
...
From what is known, both versions were made using the same material — reportedly from **Gaomaerxi (高马二溪)**. They are quite similar to Baishaxi’s [2008 "Olympics" QLC](/teas/2008-baishaxi-aoyun-qlc.html). That tea also used Gaomaerxi material, followed a similar processing method, and was notably larger than a standard QLC.

Profile wise, this production stands apart from Baishaxi’s standard-line QLCs.
